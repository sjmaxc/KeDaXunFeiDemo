...
#include "Component/SjmaxcSampleSynthComponent.h"

bool USjmaxcSampleSynthComponent::Init(int32& SampleRate)
{
	NumChannels = 1;
...
int32 USjmaxcSampleSynthComponent::OnGenerateAudio(float* OutAudio, int32 NumSamples)
{
#if SYNTHCOMPONENT_EX_OSCILATOR_ENABLED
...
void USjmaxcSampleSynthComponent::SetFrequency(const float InFrequencyHz)
{
#if SYNTHCOMPONENT_EX_OSCILATOR_ENABLED
